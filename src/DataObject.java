...
public class DataObject {
    ...
    DataObject(String userSettings, int windSpeed, String windDirection, int airPressure, int humidity, String skyCondition, int temp, int minT, int maxT, int sunRise, int sunSet){
    ...
    public void setTemp(int temp, int minT, int maxT, String user){                
